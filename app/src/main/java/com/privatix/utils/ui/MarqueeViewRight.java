 ...
 */
public class MarqueeViewRight extends LinearLayout {
    private static final int TEXTVIEW_VIRTUAL_WIDTH = 5000;
    private static final String TAG = MarqueeViewRight.class.getSimpleName();
    /**
    ...
    private int textViewWidth = 5000;
    ...
    public MarqueeViewRight(Context context) {
        super(context);
        init(context);
    }

    @SuppressWarnings({"UnusedDeclaration"})
    public MarqueeViewRight(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MarqueeViewRight(Context context, AttributeSet attrs, int defStyle) {
