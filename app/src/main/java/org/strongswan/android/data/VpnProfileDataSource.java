...
public class VpnProfileDataSource {
    ...
    private VpnProfile VpnProfileFromCursor(Cursor cursor) {
        ...
        profile.setCountryCode(cursor.getString(cursor.getColumnIndex(KEY_COUNTRY_CODE)));
        return profile;
    }
    ...
    private ContentValues ContentValuesFromVpnProfile(VpnProfile profile) {
        ...
        values.put(KEY_SPLIT_TUNNELING, profile.getSplitTunneling());
        values.put(KEY_COUNTRY_CODE, profile.getCountryCode());
        return values;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion < 8) {
                db.execSQL("ALTER TABLE " + TABLE_VPNPROFILE + " ADD " + KEY_COUNTRY_CODE +
                        " TEXT;");
            }
        }
